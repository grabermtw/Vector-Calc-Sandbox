...
namespace MK.Glow
{
    ...
    {
        private static readonly bool _argbHalfFormatSupported = SystemInfo.SupportsRenderTextureFormat(RenderTextureFormat.ARGBHalf);
        ...
        {
            return _argbHalfFormatSupported ? RenderTextureFormat.ARGBHalf : _defaultHDRFormatSupported ? RenderTextureFormat.DefaultHDR : RenderTextureFormat.Default;
        }
    }
}